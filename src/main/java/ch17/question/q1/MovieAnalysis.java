...
public class MovieAnalysis {
    public static void main(String[] args) {
        ...
        System.out.println("장르가 SF인 영화의 평균 평점 구하기 : "+answer1);
        ...
        List<String> answer3 = movies.stream()
                .sorted((m1, m2) -> Integer.compare(m2.getReleaseYear(), m1.getReleaseYear())) // 최신순 정렬
                .limit(3)
                .map(Movie::getTitle)
                .toList();

        System.out.println("가장 최근 개봉 영화 3편 → " + answer3);
        ...
        System.out.println("장르별 영화 수: " + answer4);
...
//                .map(movie -> movie.getGenre())
        ...
        System.out.println("평점이 8.5 이상 장르 (알파벳순)"+ answer5);
    }
}